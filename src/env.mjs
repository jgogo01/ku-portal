...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_KU_ALL_ACT_APPCATION_URL: z.url(),
    NEXT_PUBLIC_KU_ALL_ACT_LOGIN_AUDIT_CLIENT_ID: z.string(),
  },
  runtimeEnv: {
    ...
    NEXT_PUBLIC_KU_ALL_ACT_APPCATION_URL: process.env.NEXT_PUBLIC_KU_ALL_ACT_APPCATION_URL,
    NEXT_PUBLIC_KU_ALL_ACT_LOGIN_AUDIT_CLIENT_ID: process.env.NEXT_PUBLIC_KU_ALL_ACT_LOGIN_AUDIT_CLIENT_ID
  },
